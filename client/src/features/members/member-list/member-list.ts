...
export class MemberList implements OnInit {
  ...
  private updatedParams = new MemberParams(); // to avoid the two way binding

  // constructor has been created to parsist the filters 
  constructor() {
  ...
  get displayMessage(): string {
    ...
    filters.push(this.updatedParams.orderBy === 
      'lastActive' ? 'Recently active' : 'Newest Members')
